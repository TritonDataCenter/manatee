                ...
                function check() {
                    self._canNodeBePrimary(ctx.leader, function (err, r) {
                        ...
                        if (!r) {
                            ...
                            /*
                             * Avoid starvation here. If we are the last event
...
Shard.prototype._canBePrimary = function (cb) {
    ...
    //TODO: Distinguish between a virgin manatee instance. Otherwise with the
    //fixes to MANATEE-207 a 4th manatee can never join.
