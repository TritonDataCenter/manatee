...
PostgresMgr.prototype.startHealthCheck = function startHealthCheck(callback) {
        ...
        if (self.healthChkIntervalId) {
                ...
                self.healthChkIntervalId = setInterval(function() {
                        ...
                        // gives functional scope to timeoutId such that it can
                        // be unset in healthHandler(); This is because node
                        // may still invoke the setTimeout function even if
                        // clearTimeout has been invoked if the setTimeout is
                        // the very next item on the event queue.
                        var clozure = this;
