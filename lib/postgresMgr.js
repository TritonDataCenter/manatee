...
var BackupClient = require('./zfsClient');
...
PostgresMgr.prototype.standby = function standby(primUrl,
        ...
        self.backupClientCfg.serverUrl = backupUrl;
        var backupClient = new BackupClient(self.backupClientCfg);
                        ...
                        if (!_.isRestore) {
                                ...
                                restore(function(err) {
                                        ...
                                        if (err) {
                                                ...
                                                // TODO: delete the backup dataset
                                                return cb(err);
                                        }
                                });
                        }
        ...
        */
        function restore(cb) {
                log.info({
                        backupClientCfg: self.backupClientCfg
                }, 'PostgresMgr.standby: restoring db from primary');

                backupClient.restore(function(err2, snapshot) {
