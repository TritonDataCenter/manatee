 ...
 * http://10.0.0.0:1234
 * @param {number} options.postgresUrl  The URL of the PG instance.
...
function HeartbeatClient(options) {
    ...
    assert.string(options.postgresUrl, 'options.postgresUrl');
    ...
    this._postgresUrl = options.postgresUrl;
...
HeartbeatClient.prototype._postHeartbeat = function (callback) {
    ...
    self._client.post('/heartbeat',
                      { host: self._url, postgresUrl: self._postgresUrl },
